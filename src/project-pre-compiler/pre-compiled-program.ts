 ...
 * entièrement de la notation (le GRAFCET a des étapes et des transitions, un Ladder aura des
 * rungs). Seul le compilateur de la même notation le consomme, en le rétrécissant sur `type`.
 *
