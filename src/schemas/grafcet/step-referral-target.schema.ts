...
export type StepReferralTargetHandle =
	typeof STEP_REFERRAL_TARGET_HANDLE_SOURCE_SUCCESSOR;

export const STEP_REFERRAL_TARGET_HANDLE_SOURCE_SUCCESSOR_TYPES = [
	"step",
] as const satisfies readonly ElementType[];

export const STEP_REFERRAL_TARGET_HANDLES_TO_TYPES: Record<
	StepReferralTargetHandle,
	readonly ElementType[]
> = {
	[STEP_REFERRAL_TARGET_HANDLE_SOURCE_SUCCESSOR]:
		STEP_REFERRAL_TARGET_HANDLE_SOURCE_SUCCESSOR_TYPES,
};

export type StepReferralTargetData = {
