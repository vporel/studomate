...
export const JUNCTION_OR_START_HANDLE_PIVOT_TYPES = [
	"step",
] as const satisfies readonly ElementType[];

export const JUNCTION_OR_START_HANDLES_TO_TYPES: Record<
	JunctionHandle,
 ...
 */
export const JUNCTION_OR_START_HANDLE_BRANCH_TYPES = [
	"transition",
] as const satisfies readonly ElementType[];
