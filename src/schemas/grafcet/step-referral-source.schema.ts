...
export const STEP_REFERRAL_SOURCE_HANDLE_TARGET_PREDECESSOR =
	"target:predecessor";

export type StepReferralSourceHandle =
	typeof STEP_REFERRAL_SOURCE_HANDLE_TARGET_PREDECESSOR;
...
export const STEP_REFERRAL_SOURCE_HANDLES_TO_TYPES: Record<
	StepReferralSourceHandle,
...
export type StepReferralSourceData = {
