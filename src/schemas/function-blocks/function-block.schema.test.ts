...
describe("getBlockVariableMnemonics", () => {
	it("génère un mnémonique plat par port, préfixé du nom du bloc", () => {
		const portSpecs: BlockPortSpec[] = [
			{ suffix: "IN", type: "BOOL", kind: "structural", direction: "input", generatesVariable: true },
			{ suffix: "OUT", type: "BOOL", kind: "structural", direction: "output", generatesVariable: true },
		];
	...
	it("ignore les ports dont generatesVariable est faux", () => {
		const portSpecs: BlockPortSpec[] = [
			{ suffix: "IN", type: "BOOL", kind: "structural", direction: "input", generatesVariable: true },
			{ suffix: "PARAM", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false },
		];

		expect(getBlockVariableMnemonics("MonBloc", portSpecs)).toEqual({ IN: "MonBloc.IN" });
	});
});
...
describe("getBlockPinRowCount", () => {
	it("vaut 1 pour des ports uniquement structurels (pas de rangée de paramètres)", () => {
		const portSpecs: BlockPortSpec[] = [
			{ suffix: "EN", type: "BOOL", kind: "structural", direction: "input", generatesVariable: true },
			{ suffix: "ENO", type: "BOOL", kind: "structural", direction: "output", generatesVariable: true },
		];
	...
	it("ajoute une ligne quand une entrée et une sortie paramètres se partagent une même rangée", () => {
		const portSpecs: BlockPortSpec[] = [
			...
			{ suffix: "PT", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false },
			{ suffix: "ET", type: "TIME", kind: "parameter", direction: "output", generatesVariable: true },
		];
	...
	it("prend le maximum quand les entrées et sorties paramètres sont en nombre différent", () => {
		const portSpecs: BlockPortSpec[] = [
			{ suffix: "IN", type: "BOOL", kind: "structural", direction: "input", generatesVariable: true },
			{ suffix: "Q", type: "BOOL", kind: "structural", direction: "output", generatesVariable: true },
			{ suffix: "P1", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false },
			{ suffix: "P2", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false },
			{ suffix: "P3", type: "TIME", kind: "parameter", direction: "output", generatesVariable: true },
		];
...
describe("getParameterPinRows", () => {
	it("associe l'entrée et la sortie paramètres de même rang sur une seule ligne", () => {
		const pt: BlockPortSpec = { suffix: "PT", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false };
		const et: BlockPortSpec = { suffix: "ET", type: "TIME", kind: "parameter", direction: "output", generatesVariable: true };
		const portSpecs: BlockPortSpec[] = [
			{ suffix: "IN", type: "BOOL", kind: "structural", direction: "input", generatesVariable: true },
			{ suffix: "Q", type: "BOOL", kind: "structural", direction: "output", generatesVariable: true },
			pt,
	...
	it("laisse un côté vide quand les comptes d'entrées/sorties paramètres diffèrent", () => {
		const p1: BlockPortSpec = { suffix: "P1", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false };
		const p2: BlockPortSpec = { suffix: "P2", type: "TIME", kind: "parameter", direction: "input", generatesVariable: false };
