...
const AndJunctionStartTool = ({disabled}: {disabled?: boolean}) => {
	return (
		<GrafcetTool type="and-junction-start" disabled={disabled}>
			<Box sx={{
				...
				<Box sx={{width: "100%", height: "1px", background: "black", marginTop: "1px"}} />
...
export default AndJunctionStartTool