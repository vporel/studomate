...
import { edgeStateEventsIn } from "../edges/edges-states-events";
import { nodeStateEventsIn } from "../nodes/nodes-states-events";

export default function useCommandsHandlers(): {
	commandUndo: (command: AbstractGrafcetCommand<any> | null) => void;
	commandRedo: (command: AbstractGrafcetCommand<any> | null) => void;
} {
	...
	return { commandUndo, commandRedo };
}
