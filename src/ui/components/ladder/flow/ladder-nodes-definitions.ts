...
import BlockNode, { BLOCK_NODE_DIMENSIONS, BlockNodeType } from "../nodes/block-node/BlockNode";
import CoilNode, { COIL_NODE_DIMENSIONS, CoilNodeType } from "../nodes/CoilNode";
import ContactNode, { CONTACT_NODE_DIMENSIONS, ContactNodeType } from "../nodes/ContactNode";
import RailTerminalNode, { RAIL_TERMINAL_NODE_DIMENSIONS, RailTerminalNodeType } from "../nodes/RailTerminalNode";

export type LadderNodeType = ContactNodeType | CoilNodeType | RailTerminalNodeType | BlockNodeType;
